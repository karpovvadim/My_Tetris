...
class Figura2:
    ...
    def draw(self):
        if self.orientation == 0:
            ...
            self.window.addstr(self.y - 1, self.x + 1, "#", curses.color_pair(4))
            self.window.addstr(self.y, self.x + 1, "#", curses.color_pair(4))

        elif self.orientation == 2:
            self.window.addstr(self.y - 1, self.x + 2, "#", curses.color_pair(4))
            self.window.addstr(self.y, self.x, "###", curses.color_pair(4))
